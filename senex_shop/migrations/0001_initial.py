...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'store_category_related_categories')
        ...
        db.create_table(u'store_productimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'store', ['ProductImage'])

        # Adding unique constraint on 'ProductImage', fields ['product', 'sort']
        db.create_unique(u'store_productimage', ['product_id', 'sort'])
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'store_productimage', ['product_id', 'sort'])

        # Deleting model 'Category'
        db.delete_table(u'store_category')

        # Removing M2M table for field related_categories on 'Category'
        db.delete_table(db.shorten_name(u'store_category_related_categories'))

        # Deleting model 'Product'
        db.delete_table(u'store_product')

        # Deleting model 'ProductImage'
        db.delete_table(u'store_productimage')
