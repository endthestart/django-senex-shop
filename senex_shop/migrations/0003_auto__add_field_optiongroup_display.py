...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OptionGroup.display'
        db.add_column(u'senex_shop_optiongroup', 'display',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OptionGroup.display'
        db.delete_column(u'senex_shop_optiongroup', 'display')
    ...
    models = {
        ...
        u'senex_shop.optiongroup': {
            ...
            'display': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
